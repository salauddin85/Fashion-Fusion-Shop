...
#  def delete_products_with_wishlist(sender, instance, **kwargs):
#         products = instance.products.all()
#         for product in products:
#             product.delete()

# # Signal to delete the wishlist when a user is deleted
#     @receiver(post_delete, sender=User)
#     def delete_user_wishlist(sender, instance, **kwargs):
#         try:
